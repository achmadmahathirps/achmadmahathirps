...
<b>I'm Mahathir. I pretty much have a passion for coding, especially when it involves entertainment-related projects. My specialty lies in creating multimedia applications, mainly educational-themed or for industrial purposes.</b> 

There are several technologies that I'm using for creating the applications, such as Unity (also with Vuforia Engine for AR development) and Flutter, usually for UI/UX development. So far I code mostly using C# and Dart, while also have some experiences in coding projects using Python (computer vision and machine learning), and a little of other things. Currently expanding my skills in VR development using Meta Quest 3.
...
[![My Skills](https://skillicons.dev/icons?i=vscode,visualstudio,unity,androidstudio,blender,git,pycharm,anaconda,windows,mint&perline=7)](https://skillicons.dev)

<b>⚙&nbsp;&nbsp;Languages&nbsp;and&nbsp;frameworks</b>
<br>
  
[![My Skills](https://skillicons.dev/icons?i=cs,typescript,py,dart,flutter,postgresql,mysql)](https://skillicons.dev)
 
## 📊 Stats

<!--START_SECTION:waka-->
![Code Time](http://img.shields.io/badge/Code%20Time-498%20hrs%2011%20mins-blue?style=flat)
...
```text
🌞 Morning                304 commits         ⣿⣿⣿⣿⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   16.15 % 
🌆 Daytime                1313 commits        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣀⣀⣀⣀⣀⣀⣀⣀   69.77 % 
🌃 Evening                231 commits         ⣿⣿⣿⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   12.27 % 
🌙 Night                  34 commits          ⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   01.81 % 
```
...
Dart                     11 hrs 13 mins      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣀⣀⣀⣀⣀⣀⣀⣀⣀   63.13 % 
Python                   6 hrs 6 mins        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   34.34 % 
YAML                     16 mins             ⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   01.50 % 
XML                      8 mins              ⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   00.82 % 
C++                      1 min               ⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀   00.17 % 
...
```text
⏱ AI Coding Time: 10 mins (1.01%)

✍️ 0 lines written by AI, 33,669 lines written by hand (0.0% AI-written)
...
```
 ...
 Last Updated on 01/09/2026 19:19:55 UTC
<!--END_SECTION:waka-->
